 ...
 * 定位
 */
public class LfLocation extends XtomObject implements AMapLocationListener,
		OnGeocodeSearchListener {
	private LocationManagerProxy mAMapLocationManager;
	private AMapLocation aMapLocation;
	private GeocodeSearch geocodeSearch;
	private static LfLocation location;
	...
	public static LfLocation getInstance() {
		if (location == null)
			location = new LfLocation();
		return location;
	}
