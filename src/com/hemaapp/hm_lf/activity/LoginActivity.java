...
import com.hemaapp.hm_lf.LfUtil;
 ...
 *
 */
public class LoginActivity extends LfActivity implements OnClickListener
{
	...
	private void clickConfirm()
	{
		...
		if(!LfUtil.checkPhoneNumber(phoneNumber))
		{//验证手机号是否合法
	...
	protected void callBackForServerFailed(HemaNetTask netTask, HemaBaseResult result) {
		LfHttpInformation information = (LfHttpInformation)netTask.getHttpInformation();
		switch(information)
		{
		case CLIENT_VERIFY:
		case CLIENT_LOGIN:
